...
const WhatsAppFloat = () => {
  ...
  return (
    ...
    >
      <div className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover-scale hover-glow">
