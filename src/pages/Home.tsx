        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              asChild 
              size="lg" 
              className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black px-8 py-6 text-lg rounded-full hover:scale-105 hover:shadow-lg hover:shadow-yellow-400/30 font-semibold transition-all duration-300"
            >
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-yellow-900/20 to-transparent rounded-2xl group-hover:from-yellow-900/30 transition-all duration-300" />
            </div>
            ...
            <div className="space-y-6">
              ...
              <Button 
                asChild 
                className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black rounded-full hover:scale-105 hover:shadow-lg hover:shadow-yellow-400/30 font-semibold transition-all duration-300"
              >
                <Link to="/about">
              ...
              <Card key={product.id} className="group hover:scale-105 hover:shadow-xl hover:shadow-yellow-400/20 bg-white border-2 border-yellow-100 hover:border-yellow-300 overflow-hidden transition-all duration-300">
                <div className="grid md:grid-cols-2">
                  <div className="aspect-square overflow-hidden relative">
                    ...
                    />
                    {product.bestseller && (
                      <div className="absolute top-3 left-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black px-3 py-1 rounded-full text-sm font-semibold">
                        Bestseller
                      </div>
                    )}
                  </div>
                  <CardContent className="p-6 flex flex-col justify-center">
                    ...
                    <Button 
                      asChild
                      className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black rounded-full hover:scale-105 font-semibold transition-all duration-300"
                    >
                      <Link to="/shop">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button 
                      type="submit"
                      className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black rounded-full hover:scale-105 flex-1 transition-all duration-300"
                    >
            ...
            <div className="space-y-8">
              {/* Contact Information */}
              <Card className="hover:scale-105 hover:shadow-xl hover:shadow-yellow-400/20 border-2 border-yellow-100 hover:border-yellow-300 bg-gradient-to-br from-yellow-50 to-white transition-all duration-300">
                <CardContent className="p-6">
